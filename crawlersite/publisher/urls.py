...
urlpatterns = [
       ...
       url(r'publisher/(?P<publisher_id>[0-9]+)/$', views.update_publisher, name='update_publisher'),
       # /publisher/publisher/1/delete
       url(r'publisher/(?P<publisher_id>[0-9]+)/$', views.delete_publisher, name='delete_publisher'),
